	...
	<div class="col-8 offset-2">
		<div class="row mt-5">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="title" name="title" value="<%= article.getTitle() %>" placeholder="ex. Tuto Spring">
			</div>
			
			    <div class="form-group">
      			<label for="content" class="form-label mt-4">Contenu</label>
      			<textarea class="form-control" id="content" name="content"  "rows="3"><%= article.getContent() %></textarea>
    		</div>
    		
    		<div class="form-group">
				<label for="author" class="form-label mt-4">Auteur</label>
				<input type="text" class="form-control" id="author" name="author" value="<%= article.getAuthor()%>" placeholder="ex. Pierre">
			</div>
			<p></p>
